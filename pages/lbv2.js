import { map, preloadImages, getTranslationDistance, getDistance } from '@/components/LookBook/utils';
...
export default function Lookbook() {
    ...
    return (
        <div className="overflow-hidden bg-repeat-y bg-cover bg-black" style={{ backgroundImage: `url(/bg.png)` }}>
            <div className="grid gap-4 grid-cols-3 w-11/12 py-16 mx-auto pointer-events-none md:grid-cols-5 lg:grid-cols-8" data-duration="1" data-ease="elastic.out(0.2)" data-scale="2.2" data-max-rotation="40" data-spread="150" data-max-distance="2500">
                ...
                <div className='pb-4 relative h-full pointer-events-auto will-change-transform col-span-3 md:col-span-5 lg:col-span-8 text-5xl heading flex items-center justify-center text-white '>
                    Want to witness us in our element? Here's a sneak peak into what TEDxVITPune actually has to offer.
                </div>
                ...
                {[ 1, 2, 3, 4, 5, 6, 7 ].map((i) => (
                    <div className="grid__item relative m-0 pointer-events-auto will-change-transform">
                        <div className="grid__item-img w-full aspect-[206/139] bg-cover cursor-pointer" style={{ backgroundImage: `url(lookbook/2021/${i}.png)` }}></div>
                    </div>
                ))}
                {[ 1, 2, 3, 4, 5, 6, 7 ].map((i) => (
                    <div className="grid__item relative m-0 pointer-events-auto will-change-transform">
                        <div className="grid__item-img w-full aspect-[206/139] bg-cover cursor-pointer" style={{ backgroundImage: `url(lookbook/2019/${i}.png)` }}></div>
                    </div>
                ))}

                {[ 1, 2, 3, 4, 5, 6, 7 ].map((i) => (
                    <div className="grid__item relative m-0 pointer-events-auto will-change-transform">
                        <div className="grid__item-img w-full aspect-[206/139] bg-cover cursor-pointer" style={{ backgroundImage: `url(lookbook/2018Live/${i}.png)` }}></div>
                    </div>
                ))}
                {[ 1, 2, 3, 4, 5, 6, 7 ].map((i) => (
                    <div className="grid__item relative m-0 pointer-events-auto will-change-transform">
                        <div className="grid__item-img w-full aspect-[206/139] bg-cover cursor-pointer" style={{ backgroundImage: `url(lookbook/2018/${i}.png)` }}></div>
                    </div>
                ))}
                {[ 1, 2, 3, 4, 5, 6, 7 ].map((i) => (
                    <div className="grid__item relative m-0 pointer-events-auto will-change-transform">
                        <div className="grid__item-img w-full aspect-[206/139] bg-cover cursor-pointer" style={{ backgroundImage: `url(lookbook/2017/${i}.png)` }}></div>
                    </div>
                ))}
                {[ 1, 2, 3, 4, 5, 6, 7 ].map((i) => (
                    <div className="grid__item relative m-0 pointer-events-auto will-change-transform">
                        <div className="grid__item-img w-full aspect-[206/139] bg-cover cursor-pointer" style={{ backgroundImage: `url(lookbook/2016/${i}.png)` }}></div>
                    </div>
                ))}
            </div>
        </div>
