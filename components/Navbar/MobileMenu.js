  ...
  return (
    <>
      {isMenuMounted && (
        ...
        className={cn(
          styles.menu,
          'flex flex-col justify-between absolute right-0 top-[4.35rem] w-screen md:w-[50%] lg:w-[33%] h-screen bg-[#000]/10  ease-in duration-300',
          ...
          <div className='flex flex-row md:hidden justify-evenly mb-24'>
            ...
            <a href="https://www.youtube.com/c/TEDxVITPune" className='w-20 h-20 bg-[#161616] flex justify-center items-center rounded-full'>
