              ...
              <section className="flex items-center justify-center flex-col md:flex-row w-full h-full p-5 gap-5">
                ...
                <div className="w-full md:w-[35%] md:border-r-2 md:border-white h-full flex flex-col">
                  <section className="my-5">
                    <h2 className="text-2xl text-center md:text-left font-bold text-white">{year}</h2>
                  </section>
                ...
                <div className="w-full md:w-[65%] h-full">
                  <section className="relative h-full mx-3">
                    <div className="my-5">
                      <h2 className="heading text-3xl font-bold tracking-wide text-white">
                        {title}
                      </h2>
                    </div>

                    <div>
                      <p className="tracking-wide text-base leading-loose text-white">
                        {paragraph}
                      </p>
                    </div>

                    <div className=" my-4 block lg:absolute lg:bottom-5">
                      <button className="bg-transparent border-2 border-white text-white tracking-wider uppercase px-10 py-2 text-lg font-semibold duration-100 ease-in-out hover:text-black hover:bg-white">
