export default function FragmentsSection() {
  return (
    ...
    <div className="w-full lg:w-1/2 px-4 lg:px-8 lg:py-12 my-4">
      <h2 className="w-full font-extrabold text-8xl  xl:text-9xl text-white leading-tight heading text-center lg:text-left">
        FRAG
        <br />
        MENTS
      </h2>
    </div>
    <div className="w-full lg:w-1/2 px-5 lg:px-3 lg:py-12 my-4 text-white text-center lg:text-start font-medium text-2xl">
