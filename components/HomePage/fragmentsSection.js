  ...
  return (
    <div className="max-w-6xl mx-auto py-12 xl:pt-[100vh] lg:py-16 lg:flex lg:items-center lg:justify-between">
      <div className="w-full lg:w-1/2 px-4 lg:py-12 my-4">
        {/* <img src="/try.jpeg" /> */}
        <h2 className="w-full font-extrabold text-4xl lg:text-6xl text-white leading-tight heading text-center">
          FRAGMENTS
        </h2>
        <h2 className="w-full font-extrabold text-3xl lg:text-5xl text-gray-300 leading-tight heading text-center">
          April 30th, 2023
        </h2>
      </div>
      <div className="w-full lg:w-1/2 px-4 lg:py-12 my-4 text-white text-justify font-medium text-lg md:text-xl">
        <p>
          ...
          chaos.
          <br />
          We often wonder, will we ever seek answers? Will the chaos make
