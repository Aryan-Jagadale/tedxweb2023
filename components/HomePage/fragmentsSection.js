      ...
      <div className="max-w-6xl mx-auto py-12 lg:py-16 lg:flex lg:items-center lg:justify-between">
        ...
        <div className="w-full lg:w-1/2 px-4 lg:py-12 my-4 text-white text-justify font-medium text-lg md:text-xl">
          <p>
            ...
            sense? Now is the time we inch closer to our reality by being
            grateful for the minute moments, and not losing a sense of empathy,
            triumphing in our trials- through the balance that comes from
            within.
          </p>
